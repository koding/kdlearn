title: TogetherJS Setup
link: http://learn.koding.com/togetherjs-setup-and-usage/
author: kdlearn
description: 
post_id: 61
created: 2013/11/25 23:07:23
created_gmt: 2013/11/25 23:07:23
comment_status: closed
post_name: togetherjs-setup-and-usage
status: publish
post_type: post
...
In the following example, we'll setup TogetherJS by using a plain html page and the TogetherJS Scripts. And because we used [Koding](https://koding.com) we can share this project with our friends easily. On localhost you would have to run a web server, expose and forward your ports, figure out your ip, and finally share it with a friend. Koding saves you that localhost-hassle, and makes this a one-step process. Just share your domain and you're done. 
